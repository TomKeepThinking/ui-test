<x-app-layout>
        ...
        <x-content.offset class="mb-12">
            <x-slot:left>
                <div class="space-y-4">
                    ...
                    <h4 class="underline underline-offset-4">Inspiration</h4>
                </div>
            </x-slot:left>
            <x-slot:right>
                <div class="space-y-4">
                    <p class="text-3xl text-black">Seeking innovative ways to solve problems is in the DNA of SFMOMA, the San Francisco Museum of Modern Art, says Marla Misunas, Collections Information Manager. Teams there are no strangers to working with software vendors to come up with innovative solutions.</p>
                    ...
                    <p class="text-3xl text-black">Streamlining duplicate workflows</p>
    ...
    <x-container>
        <x-page-header class="w-4/5 pb-4">
            <h2>{{$quote['quote']}} <span class="text-grey">{{$quote['author']}}</span></h2>
        </x-page-header>
    </x-container>
    ...
    @foreach($content as $item)
        <div class="border-t border-concrete mb-8 pt-8 z-10 relative">
            <x-content.offset class="mb-20">
                <x-slot:left>
                    <h3 class="text-3xl"">{{$item['header']}}</h3>
                </x-slot:left>
